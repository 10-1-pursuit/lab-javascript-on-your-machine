 ...
 */
function calculator(plus,minus,modulo,divide) {
//console.log(process.argv)

    
   add2Num=  parseInt(`${process.argv[3]}`) +parseInt(`${process.argv[4]}`);
     
     if(process.argv[2]=== "plus" && process.argv.length < parseInt(5)){
...
//console.log(`Adding multiple numbers: ${addMultipleNum}`)
    ...
    if(process.argv[2] === "minus" && process.argv.length < parseInt(5)){
...
//console.log(`Subtracting multiplenumbers : ${subMultipleNum}`)
    ...
    if(process.argv[2] === "modulo"|| process.argv[2] === "divide"){
